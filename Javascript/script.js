// var declarations are globally scoped or function scoped while let and const are block scoped. var variables can be updated and re-declared within its scope; let variables can be updated but not re-declared; const variables can neither be updated nor re-declare

document.querySelector("[data-input]").onkeyup = (e) => {
	document.querySelector("[data-label]").textContent = e.target.value;
};


var names = ["Mary", "John", "George"];
var ul = document.createElement("ul");
document.body.appendChild(ul);
names.forEach((name) => {
	let li = document.createElement("li");
	li.innerHTML = "student name is " + name;
	ul.appendChild(li);
});
...
// I acknowledge a Code Pen script which I modified to this project, since I am not yet skilled in Javscript. I had to fix several errors and warnings
